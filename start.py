...
def start_connectors():
    ...
    command1 = erl + '-setcookie ' + COOKIE + " -s lager" + " -pa " + dep_ebin_dirs + " -detached -sname " + nodeName
...
def help():
    helpMessage = '''
        ...
        Usage:
        ./start rebuild #get all deps and generate *_pb.hrl files, then build all project
...
if __name__ == '__main__':
    commandFunMapper = { 'build':build, 'start':start, 'reset_db':reset_db,
